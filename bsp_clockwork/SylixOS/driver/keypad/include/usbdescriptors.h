...
{
    _PrintFormat("usb device descriptor \n");
    _PrintFormat("\tbLength %2.2x\n", d->bLength);
    _PrintFormat("\tbDescriptorType %2.2x\n", d->bDescriptorType);
    _PrintFormat("\tbcdUSB %4.4x\n", d->bcdUSB);
    _PrintFormat("\tbDeviceClass %2.2x\n", d->bDeviceClass);
    _PrintFormat("\tbDeviceSubClass %2.2x\n", d->bDeviceSubClass);
    _PrintFormat("\tbDeviceProtocol %2.2x\n", d->bDeviceProtocol);
    _PrintFormat("\tbMaxPacketSize0 %2.2x\n", d->bMaxPacketSize0);
    _PrintFormat("\tidVendor %4.4x\n", d->idVendor);
    _PrintFormat("\tidProduct %4.4x\n", d->idProduct);
    _PrintFormat("\tbcdDevice %4.4x\n", d->bcdDevice);
    _PrintFormat("\tiManufacturer %2.2x\n", d->iManufacturer);
    _PrintFormat("\tiProduct %2.2x\n", d->iProduct);
    _PrintFormat("\tiSerialNumber %2.2x\n", d->iSerialNumber);
    _PrintFormat("\tbNumConfigurations %2.2x\n", d->bNumConfigurations);
}
